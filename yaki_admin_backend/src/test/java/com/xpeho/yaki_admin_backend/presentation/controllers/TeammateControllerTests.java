...
class TeammateControllerTests {
    ...
    private final UserEntityWithID teammate4 = new UserEntityWithID(4, 1,1,"Dupond", "Jack", "dupond.jack@mail.com", "avatarRef", null);
    private final UserEntityWithID teammate5 = new UserEntityWithID(4, 2,2,"Dugrond", "Jean", "dugrond.jean@mail.com", "avatarRef", null);
