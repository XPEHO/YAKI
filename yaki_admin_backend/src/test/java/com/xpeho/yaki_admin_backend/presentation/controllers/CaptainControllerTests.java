...
class CaptainControllerTests {
    ...
    public void testGetAllCaptainByCustomerId() {
        ...
        expectedCaptains.add(new UserEntityWithID(1, 1,1,"Barbie", "Chette", "barbie@email.com", "avatarRef", null));
        expectedCaptains.add(new UserEntityWithID(2, 2,2,"Jean", "sérien", "jean@email.com", "avatarRef", null));
