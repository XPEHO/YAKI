Feature: GetLatestDeclaration
  ...
  Scenario: Get the latest declaration successful
    ...
    When method get
    Then status 200
    And match response contains [{ declarationId: '#number', declarationDate: '#string', declarationDateStart: '#string', declarationDateEnd: '#string', declarationTeamMateId: 4, declarationStatus: 'remote', declarationTeamId: '#number' }]
